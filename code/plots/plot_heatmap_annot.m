...
%                     
    ...
    if opts.showTxt == 1       
        [hImage, hText, hXText] = heatmapTXT(crossTable,xNamePrint, yNamePrint, round(textTable,opts.textPrec), 'TickAngle', opts.XTickLabelRotation,...
            'ShowAllTicks', true, 'TickFontSize', opts.axisFontSize,'FontSize',opts.fontSize,'Colormap',cmap,'Colorbar',{'location','eastoutside'},'mincolorvalue',clim(1),'maxcolorvalue',clim(2),'Parent',heatMapP);
   ...
   %%
    ...
    %%
    if opts.addDendrogramX > 0 && opts.doLeafOptimalOrderX 
