...
%           vector norm) of A-USV', using 20 iterations of the power
%           method started with a random vector.
%
%   snorm = diffsnorm(A,U,S,V,its)  finds an estimate snorm of the
%           spectral norm (the operator norm induced by the Euclidean
%           vector norm) of A-USV', using its iterations of the power
...
%
%
%   See also DIFFSNORMC, PCA, NORMEST, NORM.
%
